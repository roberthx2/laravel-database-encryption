...
Laravel|[v7.x](https://laravel.com/docs/7.x/releases)|[v0.4.0](https://github.com/austinheap/laravel-database-encryption/releases/tag/v0.4.0) ([Packagist](https://packagist.org/packages/austinheap/laravel-database-encryption#v0.4.0))|Stable|[![Build Status](https://travis-ci.org/austinheap/laravel-database-encryption.svg?branch=v0.4.0)](https://travis-ci.org/austinheap/laravel-database-encryption)|[![Build Status](https://travis-ci.org/austinheap/laravel-database-encryption.svg?branch=v0.4.0)](https://travis-ci.org/austinheap/laravel-database-encryption)|[![Build Status](https://travis-ci.org/austinheap/laravel-database-encryption.svg?branch=v0.4.0)](https://travis-ci.org/austinheap/laravel-database-encryption)
## Schemas
